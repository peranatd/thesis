...
class LanguageTone extends Component {
  constructor(props){
    super(props);
  }
  ...
  componentWillReceiveProps (newProps) {
    ...
    result.forEach(function(tone){
      ...
      if(tone.category_id === 'language_tone'){
    ...
    this.props.drawRadarChart('#language_tone', [data], mycfg);
...
export default connect(mapStateToProps)(LanguageTone);
